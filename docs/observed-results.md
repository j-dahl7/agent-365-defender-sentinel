...
- Do not overclaim Agent 365 telemetry until the tenant has Agent 365 onboarded. This lab was originally built as a pre-GA Defender playbook and maps the attack patterns to the controls Agent 365 now brings together.
